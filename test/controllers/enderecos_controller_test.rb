...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, cliente_id: @endereco.cliente_id, complemento: @endereco.complemento, numero: @endereco.numero, rua: @endereco.rua, state: @endereco.state } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, cliente_id: @endereco.cliente_id, complemento: @endereco.complemento, numero: @endereco.numero, rua: @endereco.rua, state: @endereco.state } }
