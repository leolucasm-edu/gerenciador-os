...
class EmailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create email" do
    assert_difference('Email.count') do
      post emails_url, params: { email: { cliente_id: @email.cliente_id, email: @email.email } }
    end
  ...
  test "should update email" do
    patch email_url(@email), params: { email: { cliente_id: @email.cliente_id, email: @email.email } }
