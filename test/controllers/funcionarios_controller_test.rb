...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { cnpj: @funcionario.cnpj, data_nascimento: @funcionario.data_nascimento, email: @funcionario.email, nome: @funcionario.nome, user_id: @funcionario.user_id } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { cnpj: @funcionario.cnpj, data_nascimento: @funcionario.data_nascimento, email: @funcionario.email, nome: @funcionario.nome, user_id: @funcionario.user_id } }
