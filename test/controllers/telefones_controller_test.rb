...
class TelefonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telefone" do
    assert_difference('Telefone.count') do
      post telefones_url, params: { telefone: { cliente_id: @telefone.cliente_id, telefone: @telefone.telefone } }
    end
  ...
  test "should update telefone" do
    patch telefone_url(@telefone), params: { telefone: { cliente_id: @telefone.cliente_id, telefone: @telefone.telefone } }
