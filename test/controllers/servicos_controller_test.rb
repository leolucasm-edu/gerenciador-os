...
class ServicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servico" do
    assert_difference('Servico.count') do
      post servicos_url, params: { servico: { descricao: @servico.descricao, preco_hora: @servico.preco_hora } }
    end
  ...
  test "should update servico" do
    patch servico_url(@servico), params: { servico: { descricao: @servico.descricao, preco_hora: @servico.preco_hora } }
